...
SHIrradianceVolume* SHIrradianceVolume::CreateIrradianceVolume( float CellLength, const RtVector3 &MinVector, const RtVector3 &MaxVector )
{
	RtVector3 DeltaVector = MaxVector - MinVector;
	...
	RtVector3 VolumeMinVector( MarginX * 0.5f + MinVector.x, MarginY * 0.5f + MinVector.y, MarginZ * 0.5f + MinVector.z );
...
SHIrradianceVolume::SHIrradianceVolume( int SizeX, int SizeY, int SizeZ, const RtVector3& BoundingBoxMinVector, float CellLength )
